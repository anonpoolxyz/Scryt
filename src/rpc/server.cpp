...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Scryt Core server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Scryt Core server stopping";
}
...
{ //  category              name                      actor (function)         okSafe argNames
  ...
  // SCRYT rpc functions
	...
	{ "wallet", "scryttxfund",          &scryttxfund,          false ,  {}},
	...
	{ "wallet", "scrytsendrawtransaction",		 &scrytsendrawtransaction,	false ,  {}},
	{ "wallet", "scrytdecoderawtransaction",		 &scrytdecoderawtransaction,	false ,  {}},
	{ "wallet", "scrytlistreceivedbyaddress",		 &scrytlistreceivedbyaddress,	false ,  {}},
	{ "wallet", "prunescrytservices",          &prunescrytservices,          false ,  {}},
...
{
    return "> scryt-cli " + methodname + " " + args + "\n";
}
