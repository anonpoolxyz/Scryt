...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in scryt.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("scryt.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Scryt features */
    { "scryt",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "scryt",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "scryt",               "gobject",                &gobject,                true,  {} },
    { "scryt",               "voteraw",                &voteraw,                true,  {} },
