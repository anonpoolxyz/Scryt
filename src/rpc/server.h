...
#ifndef SCRYT_RPCSERVER_H
#define SCRYT_RPCSERVER_H
...
extern UniValue prunescrytservices(const JSONRPCRequest& request);
...
extern UniValue scrytlistreceivedbyaddress(const JSONRPCRequest& request);
extern UniValue sendrawtransaction(const JSONRPCRequest& request);
extern UniValue createrawtransaction(const JSONRPCRequest& request);
extern UniValue scrytsendrawtransaction(const JSONRPCRequest& request);
extern UniValue scrytdecoderawtransaction(const JSONRPCRequest& request);
