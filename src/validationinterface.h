...
#ifndef SCRYT_VALIDATIONINTERFACE_H
#define SCRYT_VALIDATIONINTERFACE_H
...
protected:
	...
	virtual void NotifyScrytUpdate(const char *value, const char *topic) {}
...
struct CMainSignals {
	...
	/** Notifies listeners of an updated scryt payload with a topic. */
	boost::signals2::signal<void(const char *value, const char *topic)> NotifyScrytUpdate;
...
#endif // SCRYT_VALIDATIONINTERFACE_H
