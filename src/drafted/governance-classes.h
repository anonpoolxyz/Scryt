 ...
 *
 *   // network
 *   CScrytNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.scryt.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CScrytNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ScrytNetwork
// //   -- signature requirements : Key1(User)
// class CScrytNetworkVariable : public CGovernanceObject
// {
// private:
