...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ScrytNetwork") type = ScrytNetwork;
    if(strType == "ScrytNetworkVariable") type = ScrytNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ScrytNetwork) s = "ScrytNetwork";
    if(type == ScrytNetworkVariable) s = "ScrytNetworkVariable";
