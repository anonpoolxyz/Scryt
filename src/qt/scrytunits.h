...
#ifndef SCRYT_QT_SCRYTUNITS_H
#define SCRYT_QT_SCRYTUNITS_H
...
/** Scryt unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ScrytUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ScrytUnits(QObject *parent);

    /** Scryt units.
      @note Source: https://en.scryt.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SCY,
...
typedef ScrytUnits::Unit ScrytUnit;

#endif // SCRYT_QT_SCRYTUNITS_H
