...
#include "config/scryt-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatScrytURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + ScrytUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatScrytURI(info));
}
