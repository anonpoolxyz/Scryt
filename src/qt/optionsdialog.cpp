    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SCY-light"), QVariant("light"));
    //ui->theme->addItem(QString("SCY-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SCY-dark"), QVariant("drkblue"));
    //ui->theme->addItem(QString("SCY-Crownium"), QVariant("crownium"));
    //ui->theme->addItem(QString("SCY-traditional"), QVariant("trad"));
    
    /* Language selector */
    QDir translations(":translations");

    ui->scrytAtStartup->setToolTip(ui->scrytAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->scrytAtStartup->setText(ui->scrytAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new ScrytUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->scrytAtStartup, OptionsModel::StartAtStartup);
