...
void MasternodeList::updateMyMasternodeInfo(QString strAlias, QString strAddr, const COutPoint& outpoint)
{
    ...
    QTableWidgetItem *pubkeyItem = new QTableWidgetItem(QString::fromStdString(fFound ? CScrytAddress(infoMn.pubKeyCollateralAddress.GetID()).ToString() : ""));
...
void MasternodeList::updateNodeList()
{
    ...
    for (const auto& mnpair : mapMasternodes)
    {
        ...
        QTableWidgetItem *pubkeyItem = new QTableWidgetItem(QString::fromStdString(CScrytAddress(mn.pubKeyCollateralAddress.GetID()).ToString()));
...
void MasternodeList::ShowQRCode(std::string strAlias) {
    ...
    if (fFound) {
        ...
        strHTML += "<b>" + tr("Payee") +        ": </b>" + GUIUtil::HtmlEscape(CScrytAddress(mn.pubKeyCollateralAddress.GetID()).ToString()) + "<br>";
