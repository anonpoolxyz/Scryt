...
#ifndef SCRYT_CONSENSUS_PARAMS_H
#define SCRYT_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    int nCollateralChangeHeightv1;
    int nCollateralChangeHeightv2;
    int nCollateralChangeHeightv3;
    int nCollateralChangeHeightv4;
    int nCollateralChangeHeightv5;
    int nCollateralChangeHeightv6;
    int nCollateralChangeHeightv7;
    int nCollateralChangeHeightv8;
    int nCollateralChangeHeightv9;
    int nCollateralChangeHeightv10;
...
#endif // SCRYT_CONSENSUS_PARAMS_H
