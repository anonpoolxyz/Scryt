...
#ifndef SCRYT_WALLET_WALLET_H
#define SCRYT_WALLET_WALLET_H
...
public:
     ...
     * on this scryt node, and set to 0 for transactions that were created
...
public:
     ...
     */
    void AvailableCoins(std::vector<COutput>& vCoins, bool fOnlyConfirmed=true, const CCoinControl *coinControl = NULL, bool fIncludeZeroValue=false, AvailableCoinsType nCoinType=ALL_COINS, bool fUseInstantSend = false, bool fIncludeScrytAliasBalances = false, bool fIncludeScrytAliasOutputs = false) const;
    ...
    /// Get 18000SCY output and keys which can be used for the Masternode
