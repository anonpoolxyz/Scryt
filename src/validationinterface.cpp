...
void RegisterValidationInterface(CValidationInterface* pwalletIn) {
	...
	g_signals.NotifyScrytUpdate.connect(boost::bind(&CValidationInterface::NotifyScrytUpdate, pwalletIn, _1, _2));
...
void UnregisterValidationInterface(CValidationInterface* pwalletIn) {
	...
	g_signals.NotifyScrytUpdate.disconnect(boost::bind(&CValidationInterface::NotifyScrytUpdate, pwalletIn, _1, _2));
...
void UnregisterAllValidationInterfaces() {
	...
	g_signals.NotifyScrytUpdate.disconnect_all_slots();
