...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
	...
	UniValue r;
	CPubKey demoPubkey;
	CScrytAddress demoAddress;
	UniValue retValue;
	string strAccount = "walletDemoAccount";
	CScrytAddress setaccountDemoAddress;
	{
		LOCK(pwalletMain->cs_wallet);

		demoPubkey = pwalletMain->GenerateNewKey(0, false);
		demoAddress = CScrytAddress(CTxDestination(demoPubkey.GetID()));
		...
		setaccountDemoAddress = CScrytAddress(CTxDestination(setaccountDemoPubkey.GetID()));
	}
	/*********************************
	* 			setaccount
	*********************************/
	...
	*********************************/
	...
	BOOST_CHECK(CScrytAddress(retValue.get_str()).Get() == demoAddress.Get());
	...
	*********************************/
	...
	BOOST_CHECK(CScrytAddress(arr[0].get_str()).Get() == demoAddress.Get());
