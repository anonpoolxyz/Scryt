...
#ifndef SCRYT_TEST_SCRIPTNUM10_H
#define SCRYT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Scryt Core 0.10.0, for cross-comparison.
 */
public:
