...
#define BOOST_TEST_MODULE Scryt Test Suite

#include "test_scryt.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_scryt_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
