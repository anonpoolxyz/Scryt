            ...
            if (!mnodeman.GetMasternodeInfo(masternodeOutpoint, infoMn)) {
                ...
                if (err == CMasternode::COLLATERAL_UTXO_NOT_FOUND) {
                    ...
                    if (chainActive.Height() >= Params().GetConsensus().nCollateralChangeHeightv1) {
                        strError = "Masternode UTXO should have 1000 SCY, missing masternode=" + strOutpoint + "\n";
		    }
                    if (chainActive.Height() >= Params().GetConsensus().nCollateralChangeHeightv2) {
                        strError = "Masternode UTXO should have 1500 SCY, missing masternode=" + strOutpoint + "\n";
		    }
                    if (chainActive.Height() >= Params().GetConsensus().nCollateralChangeHeightv3) {
                        strError = "Masternode UTXO should have 2000 SCY, missing masternode=" + strOutpoint + "\n";
		    }
                    if (chainActive.Height() >= Params().GetConsensus().nCollateralChangeHeightv4) {
                        strError = "Masternode UTXO should have 2500 SCY, missing masternode=" + strOutpoint + "\n";
		    }
                    if (chainActive.Height() >= Params().GetConsensus().nCollateralChangeHeightv5) {
                        strError = "Masternode UTXO should have 3000 SCY, missing masternode=" + strOutpoint + "\n";
		    }
                    if (chainActive.Height() >= Params().GetConsensus().nCollateralChangeHeightv6) {
                        strError = "Masternode UTXO should have 3500 SCY, missing masternode=" + strOutpoint + "\n";
		    }
                    if (chainActive.Height() >= Params().GetConsensus().nCollateralChangeHeightv7) {
                        strError = "Masternode UTXO should have 4000 SCY, missing masternode=" + strOutpoint + "\n";
		    }
                    if (chainActive.Height() >= Params().GetConsensus().nCollateralChangeHeightv8) {
                        strError = "Masternode UTXO should have 5000 SCY, missing masternode=" + strOutpoint + "\n";
		    }
                    if (chainActive.Height() >= Params().GetConsensus().nCollateralChangeHeightv9) {
                        strError = "Masternode UTXO should have 6000 SCY, missing masternode=" + strOutpoint + "\n";
		    }
                    if (chainActive.Height() >= Params().GetConsensus().nCollateralChangeHeightv10) {
                        strError = "Masternode UTXO should have 8000 SCY, missing masternode=" + strOutpoint + "\n";
		    }
