...
#ifndef SCRYT_SCRIPT_SCRIPT_H
#define SCRYT_SCRIPT_SCRIPT_H
...
enum opcodetype
{
	...
	// scryt extended reserved 
	OP_SCRYT_ALIAS = 0x01,
	OP_SCRYT_CERT = 0x02,
	OP_SCRYT_ESCROW = 0x03,
	OP_SCRYT_OFFER = 0x04,
	OP_SCRYT_ASSET = 0x05,
	OP_SCRYT_ASSET_ALLOCATION = 0x06,
    OP_FALSE = OP_0,
    OP_PUSHDATA1 = 0x4c,
    OP_PUSHDATA2 = 0x4d,
    OP_PUSHDATA4 = 0x4e,
...
public:
    ...
    /**
     * Pre-version-0.6, Scryt always counted CHECKMULTISIGs
