...
#ifndef SCRYT_DBWRAPPER_H
#define SCRYT_DBWRAPPER_H
...
public:
     ...
     */
    CDBWrapper(const boost::filesystem::path& path, size_t nCacheSize, bool fMemory = false, bool fWipe = false, bool obfuscate = false, bool bScryt = false);
    ~CDBWrapper();
