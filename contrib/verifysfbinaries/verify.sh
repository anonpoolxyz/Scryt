...
###   This script attempts to download the signature file SHA256SUMS.asc from scryt.org
...
WORKINGDIR="/tmp/scryt"
TMPFILE="hashes.tmp"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://scryt.org/bin/"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the Scryt Core binary release signing key installed?"
   fi
