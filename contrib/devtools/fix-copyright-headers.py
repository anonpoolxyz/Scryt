...
// Copyright (c) 2009-2012 The ScrytExchange developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Scryt/$1-%s The Scryt/' %s"
REGEX_CURRENT= re.compile("%s The Scryt" % year)
