...
This document provides guidelines for internationalization of the Scryt Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `scryt_en.ts` remains unchanged.
