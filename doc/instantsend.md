...
This mechanism has been integrated into Bitcore-Node-Scryt which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/scryt/insight-api-scryt#web-socket-api](https://github.com/scryt/insight-api-scryt#web-socket-api) 
* API: [https://github.com/scryt/insight-api-scryt#instantsend-transactions](https://github.com/scryt/insight-api-scryt#instantsend-transactions) 
