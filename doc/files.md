...
* scryt.conf: contains configuration settings for scrytd or scryt-qt
* scrytd.pid: stores the process id of scrytd while running
...
* debug.log: contains debug information and general logging generated by scrytd or scryt-qt
